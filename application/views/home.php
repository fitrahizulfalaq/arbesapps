...
<!--     <section id="faq" class="faq">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2>Cari tau apa yang kamu butuhkan</h2>
        </div>
        ...
        <ul class="faq-list">
          ...
          <li data-aos="fade-up" data-aos-delay="100">
            <a data-toggle="collapse" class="<?= $no > 1 ? 'collapsed' : ''?>" href="#faq<?= $no?>"><?= $data->judul?> <i class="icofont-simple-up"></i></a>
            <div id="faq<?= $no?>" class="collapse <?= $no == 1 ? 'show' : ''?>" data-parent=".faq-list">
              <p>
                <?= $data->deskripsi?>
              </p>
            </div>
