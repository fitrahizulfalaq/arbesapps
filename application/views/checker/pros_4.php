    ...
    <div class="row">
      <div class="col-md-12 col-lg-12 align-items-stretch mb-12 mb-lg-12" data-aos="zoom-in">
        <div class="icon-box icon-box-pink">
          <img src="<?= base_url()?>/assets/img/pertanyaan4.png" class="img-fluid" alt="" width="350px">
          <h3>
          ...
          <p>
            <a href="<?= base_url('checker/gejala/2')?>" class="btn btn-success">Ya</a>
            <a href="<?= base_url('checker/proses/5')?>" class="btn btn-warning">Tidak</a>
          </p>
          <br>
          <p>
